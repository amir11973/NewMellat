...
namespace OfficeAutomationService
{
    public class BaseClientSymap
    {
        ...
        /// </summary>
        /// <returns></returns>
        public int GetDocTypeId(int? personID = null)
        {
            SecurityContextWTOListProvider.depId = this.GetPersonDepartmentsID(personID);
        ...
        /// </summary>
        /// <returns></returns>
        public com_gam_secretariat_webservice_complextypes_PersonDepartmentWTO[] GetLetterReceivers(string ReceiverName)
        {
            SecurityContextWTOListProvider.depId = this.GetPersonDepartmentsID();
            ...
            com_gam_secretariat_webservice_complextypes_PersonDepartmentWTO[] result = new com_gam_secretariat_webservice_complextypes_PersonDepartmentWTO[1];


            param1.searchString = ReceiverName;
            ...
            if (actual != null)
            {
                result[0] = new com_gam_secretariat_webservice_complextypes_PersonDepartmentWTO();
                result[0].personId = actual[0].id1;
                result[0].departmentId = actual[0].id2;
                return result;
            }
            return null;
        }
