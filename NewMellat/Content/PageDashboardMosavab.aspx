<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageDashboardMosavab.aspx.cs" Inherits="NewMellat.Content.PageDashboardMosavab" %>
            ...
            <table align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" valign="top" dir="rtl">
                        <asp:Label ID="Label9" runat="server" CssClass="FontStyle1" Text="مهلت عملیاتی شدن (صرفا فرم ثبت و کنترل تغییرات )"></asp:Label>
                    </td>
                    <td align="center" valign="top">
                        <asp:Label ID="Label8" runat="server" CssClass="FontStyle1" Text="مهلت ارسال پروپوزال"></asp:Label>
                    </td>
                    <td align="center" valign="top" width="200">
                        <div align="center">
                            <div align="center">
                                <dx:ASPxComboBox ID="drpPeymankar" runat="server" AnimationType="Fade" DataSourceID="sourcePeymankar" Font-Names="B Yekan" Font-Size="16px" NullText="شرکت پیمانکار" RightToLeft="True" TextField="infTitle" Theme="SoftOrange" ValueField="infId" AutoPostBack="True" OnDataBound="drpPeymankar_DataBound" OnSelectedIndexChanged="drpPeymankar_SelectedIndexChanged">
                                </dx:ASPxComboBox>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td align="center" style="padding: 5px" valign="top">
                        <dx:ASPxRoundPanel ID="ASPxRoundPanel9" runat="server" HeaderText="" Height="350px" ShowCollapseButton="True" ShowHeader="False" Theme="SoftOrange" View="GroupBox" Width="450px">
                            <PanelCollection>
                                <dx:PanelContent runat="server">
                                    <asp:Chart ID="Chart2" runat="server" DataSourceID="sourceSum2" Height="350px" Palette="SemiTransparent" RightToLeft="Yes" Width="450px">
                                        <Series>
                                            <asp:Series ChartArea="ChartArea1" ChartType="Pie" Font="B Yekan, 11pt" IsValueShownAsLabel="True" LabelFormat=" {0} عدد" LabelUrl="~/PagePages2.aspx" Legend="Legend1" Name="Series1" XValueMember="OlaviatNamr" YValueMembers="counts">
                                            </asp:Series>
                                        </Series>
                                        <ChartAreas>
                                        ...
                                        <Legends>
                                            <asp:Legend Font="B Yekan, 10pt" IsTextAutoFit="False" Name="Legend1">
                                            </asp:Legend>
                                        </Legends>
                                        <Titles>
                                            <asp:Title Font="B Yekan, 12pt" Name="Title1" Text="جمع کل بر اساس اولویت ها در مهلت عملیاتی شدن">
                                            </asp:Title>
                                        </Titles>
                                    </asp:Chart>
                                </dx:PanelContent>
...
group by mosOlaviat">
                    ...
                    <td align="center" style="padding: 5px" valign="top">
                        <dx:ASPxRoundPanel ID="ASPxRoundPanel8" runat="server" HeaderText="" Height="350px" ShowCollapseButton="True" ShowHeader="False" Theme="SoftOrange" View="GroupBox" Width="450px">
                            <PanelCollection>
                                <dx:PanelContent runat="server">
                                    <asp:Chart ID="Chart1" runat="server" DataSourceID="sourceSum1" Height="350px" Palette="SemiTransparent" RightToLeft="Yes" Width="450px">
                                        <Series>
                                            <asp:Series ChartArea="ChartArea1" ChartType="Pie" Font="B Yekan, 11pt" IsValueShownAsLabel="True" LabelFormat=" {0} عدد" LabelMapAreaAttributes=" {0}" Legend="Legend1" Name="Series1" XValueMember="OlaviatNamr" YValueMembers="counts">
                                            </asp:Series>
                                        </Series>
                                        <ChartAreas>
                                            <asp:ChartArea Name="ChartArea1">
                                        ...
                                        <Titles>
                                            <asp:Title Font="B Yekan, 12pt" Name="Title1" Text="جمع کل بر اساس اولویت ها در ارسال پروپوزال">
                                            </asp:Title>
                                        </Titles>
                                    </asp:Chart>
                                </dx:PanelContent>
