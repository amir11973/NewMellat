...
<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Content/images/Select-icon.png" OnClick="ImageButton2_Click" ToolTip="انتخاب همه" />
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" RightToLeft="True" Theme="Office2010Silver" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared" Width="100%" KeyFieldName="mosId" OnCommandButtonInitialize="ASPxGridView1_CommandButtonInitialize" OnRowCommand="ASPxGridView1_RowCommand" Font-Names="vazir" OnDataBound="ASPxGridView1_DataBound" OnPageIndexChanged="ASPxGridView1_PageIndexChanged" OnProcessColumnAutoFilter="ASPxGridView1_ProcessColumnAutoFilter">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="شناسه" FieldName="mosShenase" VisibleIndex="5" ShowInCustomizationForm="True">
            ...
            <dx:GridViewDataDateColumn Caption="تاریخ نامه" FieldName="mosDate" ShowInCustomizationForm="True" VisibleIndex="6">
                <Settings AllowAutoFilter="False" />
                <DataItemTemplate>
            ...
            <dx:GridViewDataTextColumn Caption="اتمام یافته" VisibleIndex="9">
                <EditFormSettings Visible="False" />
                <DataItemTemplate>
            ...
            <dx:GridViewDataTextColumn Caption="ادغام شده" VisibleIndex="10">
                <EditFormSettings Visible="False" />
                <DataItemTemplate>
            ...
            <dx:GridViewDataDateColumn Caption="مهلت ارسال پروپوزال" FieldName="mosErsalDate" VisibleIndex="8">
            ...
            <dx:GridViewDataTextColumn Caption="لغو شده" VisibleIndex="11">
                <EditFormSettings Visible="False" />
                <DataItemTemplate>
            ...
            <dx:GridViewDataComboBoxColumn Caption="نوع پروژه" FieldName="prProjectType" VisibleIndex="12">
                <PropertiesComboBox DataSourceID="sourceProjectType" TextField="infTitle" ValueField="infId">
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
            <dx:GridViewDataComboBoxColumn Caption="آخرین وضعیت پروژه" FieldName="prProjectStatus" VisibleIndex="13">
                <PropertiesComboBox DataSourceID="sourceLastStatus" TextField="infTitle" ValueField="infTitle">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>
            <dx:GridViewDataComboBoxColumn Caption="اولویت" FieldName="prOlaviat" VisibleIndex="14">
                <PropertiesComboBox DataSourceID="sourceOlaviat" TextField="infTitle" ValueField="infId">
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
            <dx:GridViewDataTextColumn VisibleIndex="15" Width="50px" Caption="بازگشت">
                <DataItemTemplate>
                    <asp:ImageButton ID="ImageButton3" runat="server" CommandArgument='<%# Eval("mosId") %>' CommandName="bk" ImageUrl="~/Content/images/icons/refresh-icon.png" Enabled="False" />
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="مهلت ارسال srs" FieldName="mosSRS" VisibleIndex="16">
                <DataItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("mosSRS") %>'></asp:Label>
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="مهلت پاسخگویی به srs" FieldName="mosSRSanswer" VisibleIndex="17">
                <DataItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("mosSRSanswer") %>'></asp:Label>
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="شماره جلسه خبرگان" FieldName="khJalaseNumber" VisibleIndex="18">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="توضیحات  مصوب" FieldName="mosbody" VisibleIndex="19">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
        </Columns>
        <Styles>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" SelectCommand="SELECT tbKhobreganMosavab.mosShenase, tbKhobreganMosavab.mosNumber, DimDate.PersianStr mosAmaliatiDate, tbKhbregan.khAct, tbKhobreganMosavab.mosAct, tbKhbregan.khId, 
	tbKhbregan.khProject, tbKhobreganMosavab.mosId, DimDate_1.PersianStr mosDate, tbKhobreganMosavab.mosPropozal, DimDate_2.PersianStr as mosErsalDate, tbProjects.prTitle, 
	tbProjects.prVahed, tbProjects.prProjectType, tbProjects.prSanadType, tbProjects.prOlaviat, tbProjects.prPeymankar, tbProjects.prId, tbProjects.prProjectStatus, 
...
WHERE (tbKhbregan.khAct = 1) AND (tbKhobreganMosavab.mosAct = 1)" UpdateCommand="UPDATE tbKhobreganMosavab SET mosShenase = @mosShenase, mosDate = @mosDate, mosErsalDate = @mosErsalDate, mosAmaliatiDate = @mosAmaliatiDate, mosSRS = @mosSRS, mosSRSanswer = @mosSRSanswer WHERE (mosId = @mosId)">
        <UpdateParameters>
