<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageSooratPage.aspx.cs" Inherits="NewMellat.Content.PageSooratPage" %>
        ...
        <table align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="RightColumn">
                    &nbsp;</td>
                <td align="right">
                    <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" EnableTheming="True" Theme="SoftOrange">
                        <Items>
                            <dx:ListEditItem Text="تاخیر" Value="0" />
                            <dx:ListEditItem Text="عدم تاخیر" Value="1" />
                        </Items>
                    </dx:ASPxComboBox>
                </td>
                <td class="RightColumn">
