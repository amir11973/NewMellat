...
paEdare=case paEdare when 1 then N'تایید' when 2 then N'عدم تایید' when 3 then N'بدون پاسخ' end
 ...
 WHERE (paAct = 1) AND (paType = @paType) AND (paProject = @paProject)" UpdateCommand="UPDATE tbProjectPaper SET paShenase = @paShenase, paNumber = @paNumber, paBody = @paBody, paEdare = @paEdare WHERE (paId = @paId)">
                <DeleteParameters>
