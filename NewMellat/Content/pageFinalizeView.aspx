...
<body>
        ...
        <script>
            $(document).ready(function () {
                ...
                if (un === 'm.khanahmadi' || un === 'a.hadimanesh')
                    columns.unshift({
                        data: 'id', title: '', "render": function (data, type, row, meta) {
                            return '<a  target="_blank" href="http://172.22.65.16:1983/content/pageFinalizeEdit.aspx?id=' + data + '">ویرایش</a>';
                        }
                    });
                $('#div1111').DataTable({
                    data: myData,
