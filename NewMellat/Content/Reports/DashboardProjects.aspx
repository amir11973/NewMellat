<%@ Page Title="" Language="C#" MasterPageFile="~/SiteRibbon.Master" AutoEventWireup="true" CodeBehind="DashboardProjects.aspx.cs" Inherits="NewMellat.Content.Reports.DashboardProjects" %>
...
<div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" ProcessingMode="Remote" ShowBackButton="False" ShowFindControls="False" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" ZoomMode="PageWidth">
            <ServerReport ReportPath="/MellatReports/ReportProjects" ReportServerUrl="http://172.22.65.20/ReportServer_SQL2016" />
        </rsweb:ReportViewer>
</div>
</asp:Content>
