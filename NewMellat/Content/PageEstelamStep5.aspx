...
WHERE      prProjectStatus=N'در حال اجرا' and tbProjectPaper.paAct=1 and      (tbTarhPishnehadi.thAct = 1) AND (tbProjects.prIsMohtava = 0) AND (tbProjects.prEstelamIsSubmit = 1) AND (tbTarhPishnehadi.thIsCancle = 0) AND (tbNazar.nzAct = 1) AND (tbNazar.nzType = 10) and tbNazar.nzStatus in( 195,423)
