<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="PageHeyatNezarat.aspx.cs" Inherits="NewMellat.Content.PageHeyatNezarat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function loadDoc2(parent) {var oWnd = radopen("PageHeyatNezaratMosavab.aspx?id=" + parent, "RadWindow2");
    ...
    <div>
        <div>
            <div style="height: 270px; padding-top: 9px;" dir="ltr" class="box box-danger">
                ...
                <dx:ASPxTokenBox ID="tokenVahed" runat="server" AllowMouseWheel="True" AnimationType="Fade" DataSourceID="sourceNezarat" RightToLeft="True" Theme="SoftOrange" Tokens="" TextField="prTitle" ValueField="thId" Font-Names="vazir" Font-Size="13px" Height="25px" Width="98%" TabIndex="1">
    ...
    <div class="box box-danger">
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="Office2010Silver" AutoGenerateColumns="False" DataSourceID="sourceHeyatNezarat" RightToLeft="True" Width="100%" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared" KeyFieldName="heId" OnCommandButtonInitialize="ASPxGridView1_CommandButtonInitialize" Font-Names="vazir">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="شماره جلسه " VisibleIndex="4" FieldName="heJalaseNumber">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="ابلاغ" VisibleIndex="7">
                    <EditFormSettings Visible="False" />
                    <DataItemTemplate>
                        <asp:HyperLink ID="HyperLink4" runat="server" ImageUrl="~/Content/images/icons/mp3tag-icon.png" Target="_blank"></asp:HyperLink>
                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("heId") %>' />
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="رد" VisibleIndex="7" Visible="False">
                    <DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn Caption="توقف" VisibleIndex="8" Visible="False">
                    <DataItemTemplate>
                        <asp:HyperLink ID="HyperLink6" runat="server" ImageUrl="~/Content/images/icons/missed-calls-icon.png"></asp:HyperLink>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="ضمایم" VisibleIndex="10">
                    <EditFormSettings Visible="False" />
                    <DataItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Content/images/icons/attachment-icon24.png" Target="_blank" NavigateUrl='<%# Eval("heId","~/content/PageAttach.aspx?Parent={0}") %>'></asp:HyperLink>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="نامه ها" VisibleIndex="11">
                    <EditFormSettings Visible="False" />
                    <DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn Caption="شناسه صورتجلسه" VisibleIndex="6">
                    <EditFormSettings Visible="False" />
                    <DataItemTemplate>
                        <div align="center">
                            <table align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <asp:HyperLink ID="HyperLink7" runat="server" ImageUrl="~/Content/images/icons/Info-icon.png" NavigateUrl='<%# Eval("heId","~/content/PageSheaseNumber.aspx?id={0}") %>' Target="_blank">HyperLink</asp:HyperLink>
                                    </td>
                                    <td>
                                        <dx:ASPxCheckBox ID="ASPxCheckBox2" runat="server" Theme="SoftOrange">
                                        </dx:ASPxCheckBox>
                                    </td>
                                </tr>
                            </table>
                ...
                <dx:GridViewDataTextColumn Caption="تاریخ برگزاری جلسه" FieldName="heJalaseDate" VisibleIndex="5">
                    <PropertiesTextEdit DisplayFormatString="d">
                    </PropertiesTextEdit>
                    <Settings AllowAutoFilter="False" />
                    <DataItemTemplate>
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("heJalaseDate") %>'></asp:Label>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn Caption="نوع درخواست" VisibleIndex="14">
                    <Settings AllowAutoFilter="False" />
                    <DataItemTemplate>
                        <asp:Label ID="Label6" runat="server" Font-Names="vazir" Font-Size="12px" ForeColor="#006600" Text="الحاقیه"></asp:Label>
                        <asp:Label ID="Label7" runat="server" Font-Names="vazir" Font-Size="12px" ForeColor="#003366" Text="پروپوزال"></asp:Label>
                        <asp:HiddenField ID="HiddenField3" runat="server" Value='<%# Eval("prId") %>' />
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataComboBoxColumn Caption="شرکت" VisibleIndex="13" FieldName="prPeymankar">
        ...
        <asp:SqlDataSource ID="sourceHeyatNezarat" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" InsertCommand="INSERT INTO tbHeyatNezarat
                         (heAct, heProject, heJalaseNumber, heJalaseDate, heIsElhaghie,ProposalId)
VALUES        (1,@heProject,@heJalaseNumber,@heJalaseDate,@heIsElhaghie,@ProposalId)
SELECT @heId = SCOPE_IDENTITY()" SelectCommand="SELECT tbProjects.prTitle, tbHeyatNezarat.heJalaseDate, tbHeyatNezarat.heJalaseNumber, tbHeyatNezarat.heId, tbProjects.prVahed,tbProjects.TechnicalSuvisor, tbProjects.prPeymankar, tbHeyatNezarat.heIsElhaghie, tbProjects.prId FROM tbHeyatNezarat 
Inner jOIN tbTarhPishnehadi On tbHeyatNezarat.ProposalId = tbTarhPishnehadi.thId
INNER JOIN tbProjects ON tbHeyatNezarat.heProject = tbProjects.prId WHERE (tbHeyatNezarat.heAct = 1) AND (tbProjects.irIsAnalyz = 1) and (tbTarhPishnehadi.NezaratMosavab <> 1 or  tbTarhPishnehadi.NezaratMosavab is null)   and ((prVahed IN (SELECT prProject  FROM tbAdminProjects WHERE (prType = 3)  AND (prCode = @prCode)  )) 
...
DeleteCommand="UPDATE tbHeyatNezarat SET heAct = 0 WHERE (heId = @heId)" UpdateCommand="UPDATE tbHeyatNezarat SET heJalaseNumber = @heJalaseNumber, heJalaseDate = @heJalaseDate WHERE (heId = @heId)" OnInserted="sourceHeyatNezarat_Inserted">
            <DeleteParameters>
                <asp:Parameter Name="heId" />
            </DeleteParameters>
            <SelectParameters>
                <asp:Parameter Name="prCode" />
            </SelectParameters>
            <InsertParameters>
                <asp:Parameter Name="heProject" />
                <asp:ControlParameter ControlID="txtJalaseNumber" Name="heJalaseNumber" PropertyName="Text" />
                <asp:Parameter Name="heJalaseDate" />
                <asp:Parameter Name="heIsElhaghie" />
                <asp:Parameter Name="ProposalId" />
                <asp:Parameter Name="heId" Direction="Output" Type="Int32" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="heJalaseNumber" />
                <asp:Parameter Name="heJalaseDate" />
                <asp:Parameter Name="heId" />
            </UpdateParameters>
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="sourcePaper" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" InsertCommand="spInsertPaper" InsertCommandType="StoredProcedure" SelectCommand="SELECT TOP (1) infId FROM prInformation">
            <InsertParameters>
                ...
                <asp:Parameter Name="paType" Type="Int32" DefaultValue="150" />
    ...
    <asp:SqlDataSource ID="sourceFile" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" InsertCommand="INSERT INTO tbFiles(fiAct, fiData, fiDate, fiParent, fiType, fiTitle, fiExt) VALUES (1, @fiData, GetDate(), @fiParent, 8, @fiTitle, @fiExt)" SelectCommand="SELECT TOP (1) fiId, fiAct, fiData, fiDate, fiParent, fiType FROM tbFiles">
        ...
        <asp:SqlDataSource ID="sourceNezarat" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" SelectCommand="SELECT  tbTarhPishnehadi.thId as thId,Cast(tbProjects.prTitle as NVARCHAR(MAX)) prTitle FROM 
tbProjects INNER JOIN tbTarhPishnehadi ON tbProjects.prId = tbTarhPishnehadi.thProject Left Outer Join
tbHeyatNezarat On tbTarhPishnehadi.thId = tbHeyatNezarat.ProposalId

 WHERE (tbTarhPishnehadi.thAct = 1) AND (tbProjects.irIsAnalyz = 1)  
AND (tbProjects.prIsTarh = 1)  and tbHeyatNezarat.heId is null   and ((prVahed IN (SELECT prProject  FROM tbAdminProjects WHERE (prType = 3)  AND (prCode = @prCode)  )) 
		OR(TechnicalSuvisor IN (SELECT prProject  FROM tbAdminProjects  WHERE (prType = 3) AND (prCode = @prCode) ))) 
AND (prPeymankar IN (SELECT prProject FROM tbAdminProjects AS tbAdminProjects_1 WHERE (prType = 1)  AND (prCode = @prCode) )) 
order by tbProjects.prId DESC"><SelectParameters>
                <asp:Parameter Name="prCode" />
