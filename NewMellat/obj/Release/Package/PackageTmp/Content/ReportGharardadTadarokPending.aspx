<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ReportGharardadTadarokPending.aspx.cs" Inherits="NewMellat.Content.ReportGharardadTadarokPending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="display: none">
        ...
        <div style="padding: 9px;display: block" class="box box-danger">
            <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" EnableTheming="True" RightToLeft="True" Theme="Office2010Silver" Width="100%" Font-Names="vazir">
                <SettingsPager Mode="ShowAllRecords" Visible="False">
                </SettingsPager>
                <SettingsBehavior EnableRowHotTrack="True" />
                <SettingsText EmptyDataRow="اطلاعات موجود نمی باشد" />
                <Columns>
                    <dx:GridViewDataTextColumn Caption="نام پروژه" FieldName="Column1" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="واحد" FieldName="Column2" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Column3" Visible="False" VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataTextColumn Caption="مهلت" FieldName="Column6" VisibleIndex="6" Visible="False">
                    </dx:GridViewDataTextColumn>
                </Columns>
            </dx:ASPxGridView>
        </div>
