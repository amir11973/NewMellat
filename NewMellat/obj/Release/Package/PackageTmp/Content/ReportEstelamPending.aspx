<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ReportEstelamPending.aspx.cs" Inherits="NewMellat.Content.ReportEstelamPending" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="sourceInfo" EnableTheming="True" KeyFieldName="prId" RightToLeft="True" Theme="Office2010Silver" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared" Width="100%">
        <SettingsPager PageSize="25" Mode="ShowAllRecords" Visible="False">
        </SettingsPager>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="وضعیت پاسخ استعلام" VisibleIndex="13">
                <DataItemTemplate>
                    ...
                    <asp:HiddenField ID="HiddenField3" runat="server" Value='<%# Eval("thIsEstelamRepeat") %>' />
