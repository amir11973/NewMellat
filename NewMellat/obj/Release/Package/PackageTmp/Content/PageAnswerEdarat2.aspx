<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageAnswerEdarat2.aspx.cs" Inherits="NewMellat.Content.PageAnswerEdarat2" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="RightColumn">
                &nbsp;</td>
            <td class="LeftColumn">
                <dx:ASPxComboBox ID="drpNazarType" runat="server" AnimationType="Fade" DataSourceID="sourceNazarType" RightToLeft="True" TextField="infTitle" Theme="SoftOrange" ValueField="infId" Font-Names="B Yekan" Font-Size="13px" Width="250px" Visible="False">
                </dx:ASPxComboBox>
            ...
            <td class="RightColumn">
                <asp:Label ID="Label1" runat="server" Text=":اعلام نظر" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="LeftColumn">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="پاسخ" VisibleIndex="6">
                    <DataItemTemplate>
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Content/images/icons/add-icon.png" NavigateUrl='<%# Eval("nzId", "~/content/PageEdarat.aspx?project={0}&type=41") %>'></asp:HyperLink>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
            </Columns>
            <Styles>
