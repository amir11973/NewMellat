<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="PageSooratOdatsMali.aspx.cs" Inherits="NewMellat.Content.PageSooratOdatsMali" %>
...
<dx:GridViewDataTextColumn Caption="شرکت" VisibleIndex="6" FieldName="CompanyName">
    <Settings AutoFilterCondition="Contains" />
        ...
        <dx:GridViewDataTextColumn Caption="پرداخت" VisibleIndex="13">
            <Settings AutoFilterCondition="Contains" />
            <DataItemTemplate>
                <asp:HyperLink ID="HyperLink3" runat="server" ImageUrl="~/Content/images/icons/green-mail-send-icon.png" NavigateUrl='<%# Eval("id", "~/content/PageSooratPaper.aspx?project={0}&type=1015") %>' Target="_blank"></asp:HyperLink>
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
