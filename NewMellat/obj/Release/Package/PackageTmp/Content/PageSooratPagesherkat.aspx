<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageSooratPagesherkat.aspx.cs" Inherits="NewMellat.Content.PageSooratPagesherkat" %>
    ...
    <div align="center">
        ...
        <table align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="RightColumn">
                    <asp:Label ID="Label6" runat="server" Text=":نام شرکت"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
