<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageAnswerGharardad.aspx.cs" Inherits="NewMellat.Content.PageAnswerGharardad" %>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="ارسال به شرکت" VisibleIndex="6">
                    <DataItemTemplate>
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Content/images/icons/add-icon.png" NavigateUrl='<%# Eval("nzId", "~/content/PageEdarat.aspx?project={0}&type=2") %>' Target="_blank" Visible="False"></asp:HyperLink>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
            </Columns>
            <Styles>
