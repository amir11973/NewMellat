<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageSooratPaperEdareMali.aspx.cs" Inherits="NewMellat.Content.PageSooratPaperEdareMali" %>
        ...
        <table align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="RightColumn">
                    &nbsp;</td>
                <td align="right">
                <dx:ASPxComboBox ID="drpVahed" runat="server" AnimationType="Fade" Theme="SoftOrange" Width="250px" DataSourceID="sourceVahed" RightToLeft="True" TextField="infTitle" ValueField="infId" Font-Names="B Yekan" Font-Size="14px" TabIndex="2">
                </dx:ASPxComboBox>
                </td>
                <td class="RightColumn">
                    <asp:Label ID="Label6" runat="server" Text=":اداره"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="SoftOrange" AutoGenerateColumns="False" DataSourceID="sourcePages" KeyFieldName="paId" RightToLeft="True" Width="100%">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="پاسخ" VisibleIndex="5">
                    <DataItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Content/images/icons/Email-Reply-icon.png" NavigateUrl='<%# Eval("paProject", "~/Content/PageSooratPaperErsalMali.aspx?project={0}&type=1018") %>' Target="_parent"></asp:HyperLink>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
            </Columns>
            <Styles>
...
when 2 then N'عدم تایید'
 ...
 FROM tbProjectPaper WHERE (paAct = 1) AND (paType = @paType) AND (paProject = @paProject)" UpdateCommand="UPDATE tbProjectPaper SET paShenase = @paShenase, paNumber = @paNumber, paBody = @paBody, paEdare = @paEdare WHERE (paId = @paId)">
                ...
                <InsertParameters>
                    ...
                    <asp:ControlParameter ControlID="drpVahed" Name="paEdare" PropertyName="Value" />
                </InsertParameters>
                <SelectParameters>
                    <asp:QueryStringParameter Name="paType" QueryStringField="type" />
