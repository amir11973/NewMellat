<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportAnswerSherkatPending.aspx.cs" Inherits="NewMellat.Content.ReportAnswerSherkatPending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="sourceInfo" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" SelectCommand="SELECT * FROM [vwEstelamMohtavayiErsalBeSherkat]"></asp:SqlDataSource>
<div align="center">
