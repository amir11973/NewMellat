<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageSooratPaperErsal.aspx.cs" Inherits="NewMellat.Content.PageSooratPaperErsal" %>
       ...
       <div align="center">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="SoftOrange" AutoGenerateColumns="False" DataSourceID="sourcePages" KeyFieldName="paId" RightToLeft="True" Width="100%">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="ارسال به تدارکات" VisibleIndex="5">
                    <DataItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Content/images/icons/email-send-icon.png" NavigateUrl='<%# Eval("paProject", "~/Content/PageSooratPaper.aspx?project={0}&type=1014") %>' Target="_parent"></asp:HyperLink>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
            </Columns>
            <Styles>
